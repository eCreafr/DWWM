    ...
    <div class="card ">
      <a href="{$product.url}" class="{$componentName}__link">
        ...
        {block name='product_miniature_image'}
          <div class="{$componentName}__image-container thumbnail-container {if $product.quantity < 1}opacity-25{/if}">
            {if $product.cover}
              <picture>
            ...
            <div class="{$componentName}__prices">
              {block name='product_price'}
                {if $product.show_price}
                  ...
                  <span style="{if $product.price <20}color:#FF0000;{elseif  $product.price > 40 }color:#00FF00;{else}{/if}" class="{$componentName}__price" aria-label="{l s='Price' d='Shop.Theme.Catalog'}">
