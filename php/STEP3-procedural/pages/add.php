<div class="d-flex flex-column min-vh-100">
    <div class="container">
        ...
        <form action="addpost.html" method="POST">
            ...
            <!--  case à cocher pour developper option ajout d'un match -->
            ...
            <button type="submit" class="btn btn-primary">Envoyer</button> <a class="btn btn-primary" role="button" href="home.html">RETOUR</a>
        </form>
