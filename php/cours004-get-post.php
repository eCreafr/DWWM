...
-->
    ...
    <div class="cadre">
        ...
        <p>
            ...
            Les noms des champs de formulaire sont les clés de ce tableau.</p>
        <p> en savoir plus sur la doc officielle :
            <a href="https://www.php.net/manual/fr/reserved.variables.post.php">https://www.php.net/manual/fr/reserved.variables.post.php</a>
        </p>
        <br>
